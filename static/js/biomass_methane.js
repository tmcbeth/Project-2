...
function makePlotly() {
  ...
  var conor2chart = "/state_emission2";
  d3.json(conor2chart).then(function (response) {
    ...
    var biomass_generation = response.biomass_generation;
    ...
    Plotly.newPlot('conor2', data, layout);
